...
// Custom Github Icon (since Lucide v1 removed brand logos)
...
const Button = ({ variant = "default", size = "sm", className = "", children, asChild = false, ...props }: ButtonProps) => {
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between gap-4">
            ...
            <div className="flex-none">
              <a href="#home" className="text-lg md:text-xl font-bold text-white tracking-tighter hover:opacity-80 transition-opacity">
                SAKA CREATIVE
              </a>
            </div>

            {/* Glassmorphic Navigation Pills */}
            <div className="hidden lg:flex items-center space-x-1 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 p-1">
              <a
                href="#home"
                className="rounded-full px-4 py-2 text-xs font-medium text-white/70 transition-all hover:bg-white/10 hover:text-white"
              >
                Home
              </a>
              <a
            ...
            {/* CTA Button */}
            <div className="flex-none">
              <Button size="sm" className="rounded-full bg-white text-black hover:bg-white/90 font-bold px-6 h-10 shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all active:scale-95" asChild>
                <a href="#contact" className="flex items-center whitespace-nowrap">
                  Contact Us
